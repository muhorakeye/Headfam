...
export default function NCRGallery(): JSX.Element {
  return (
    <section id="ncr-gallery" className="py-16 px-6 md:px-16" style={{ backgroundColor: '#f9f6f0' }}>
      ...
      >
        ...
        >
          A closer look at what HeadFam Africa built, eco-resort accommodation, campsite facilities, and natural landscapes.
        </p>
      </motion.div>
        ...
        >
          ...
          >
            <div>
              ...
              >
                HeadFam Africa understood the vision from day one. They built us a resort that works
                with the land, not against it. Every guest who comes here tells us how special this
                place feels. That is HeadFam's work.
              </p>
            </div>
          ...
          <div className="bg-white rounded-2xl p-6">
            ...
            >
              Noble Cheer is the most unique place I have stayed in Rwanda. The resort is beautiful,
              the campsite is well built, and you can feel the quality of HeadFam's construction in
              every detail.
            </p>
            <div className="flex items-center gap-3">
              <div
