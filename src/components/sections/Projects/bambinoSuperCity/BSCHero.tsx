...
export default function BSCHero(): JSX.Element {
  ...
  const scrollToOverview = () => {
    const el = document.getElementById('bsc-overview')
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Home &rsaquo; Projects &rsaquo; Bambino Super City
        </motion.p>
        ...
        >
          A landmark eco-resort built by HeadFam Africa in the heart of Kigali. Sustainable design,
          local workforce, and lasting community impact.
        </motion.p>
