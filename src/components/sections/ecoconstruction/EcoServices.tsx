...
const SERVICES: Service[] = [
  {
    ...
    detail1: { label: 'Best for', value: 'Tourism investors, hospitality developers and others' },
  ...
  },
  {
    ...
    detail1: { label: 'Best for', value: 'Safari operators, nature tourism developers and others' },
  ...
  },
  {
    ...
    detail1: { label: 'Best for', value: 'Private homeowners, holiday home developers, luxury hospitality and others' },
  ...
  },
  {
    ...
    detail1: { label: 'Best for', value: 'Adventure tourism, national park operators and others' },
  ...
  },
  {
    ...
    detail1: { label: 'Best for', value: 'Tourism destinations, cultural centers and others' },
  ...
  },
  {
    ...
    detail1: { label: 'Best for', value: 'Real estate developers, urban housing projects and others' },
  ...
  },
  {
    ...
    detail1: { label: 'Best for', value: 'Homeowners, residential developers and others' },
  ...
  },
  {
    ...
    detail1: { label: 'Best for', value: 'Resorts, parks, corporate campuses, private gardensand others' },
  ...
  },
  {
    ...
    detail1: { label: 'Best for', value: 'Government, NGOs, cultural organizations and others' },
