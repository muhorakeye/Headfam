...
const MOSAIC: MosaicProject[] = [
  ...
  },
  {
    ...
    description: 'A landmark eco-resort built by HeadFam Africa in Kigali, featuring sustainable design, a local workforce, and a new standard for eco-hospitality in Rwanda.',
