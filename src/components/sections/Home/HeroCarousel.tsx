      ...
      <div className="absolute inset-0 z-20 flex flex-col justify-end p-6 md:p-12 pointer-events-none">
        <div className="flex flex-col md:flex-row md:items-end md:justify-between w-full gap-6 pointer-events-auto">
          <div className="max-w-2xl">
            ...
            <p className="text-sm md:text-base lg:text-lg font-semibold text-white max-w-lg leading-relaxed">
              Take your time with this site. What we do is worth understanding.
          ...
          >
            <div className="flex items-center">
              ...
              <a href="tel:+250788326612" className="text-white text-xs font-semibold">+250 788 326 612 / +250788342938 </a>
            </div>
