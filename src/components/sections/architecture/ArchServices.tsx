...
const SERVICES: Service[] = [
  {
    ...
    detail1: { label: 'Best for', value: 'Residential, commercial, hospitality projects and others' },
  ...
  },
  {
    ...
    detail1: { label: 'Best for', value: 'Tourism developers, hospitality investors and others' },
  ...
  },
  {
    ...
    detail1: { label: 'Best for', value: 'Private clients, holiday home developers, luxury hospitality and others' },
  ...
  },
  {
    ...
    detail1: { label: 'Best for', value: 'Resorts, parks, private estates, urban spaces and others' },
  ...
  },
  {
    ...
    detail1: { label: 'Best for', value: 'Tourism operators, community businesses and others' },
